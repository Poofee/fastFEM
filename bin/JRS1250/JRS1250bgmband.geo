...
Point(52) = {0, CS_JINGTIEXIN+22.47-11.05, 0, lc};
Point(53) = {20.01/2, CS_DONGTIEXIN+38.17-GAP-20.98-11.14-3, 0, maxsize};
Point(54) = {0, CS_DONGTIEXIN+38.17-GAP-20.98-11.14-3, 0, maxsize};
Point(55) = {41.9/2+2.5, CS_JINGTIEXIN+22.47-11.05, 0, lc};
Point(56) = {41.9/2+2.5, CS_DAOCIHUAN+0, 0, lc};
Point(57) = {(41.92)/2, CS_SHANGGAI+0, 0, lc};
//+
Line(1) = {1, 2};
//+
Line(2) = {2, 3};
...
Plane Surface(7) = {7};
//+
Curve Loop(8) = {38, 39, -44, -43, -54, -64, -45, 46};
//+
Plane Surface(8) = {8};
//+
...
Plane Surface(9) = {9};
//+
Curve Loop(10) = {54, -42, -22, -18, 57};
//+
Plane Surface(10) = {10};
//+
Curve Loop(11) = {24, -56, 14, 15, 16, 17, -55, 26, 31, 41};
//+
Plane Surface(11) = {11};
//+
Curve Loop(12) = {51, -47, 48, -60, -30, -29, -28, -37, -36, -35, -34, -40, -39, -38, 58, 59, 62};
//+
Plane Surface(12) = {12};
//+
Curve Loop(13) = {59, -61, -60, 25, 55, 63, 56, 65, 20, 21, 57, -64, -45, 46, 58};
//+
