...
Z0 = 0.005;%the guess value  1  0.005
U = 0:0.0001:10;
I = arrayfun(@r,U);
...
for i = 1:100
    ...
    ia = ua/Z0-2*Ui/Z0;
    %
    line([ub,ua],[ib,ia],'LineWidth',0.4,'Color','k')
%     line([0,ub],[-2*Ui/Z0,ib],'LineWidth',1,'Color','r','LineStyle','--')
    plot(ua, ia,'.k','MarkerSize',5,'markerfacecolor', 'black')
%     pause(1)
...
%     count = count+1;
%     end
    line([ua,ub],[ia,ib],'LineWidth',0.4,'Color','k')
%     line([0,ua],[2*Ur/Z0,ia],'LineWidth',1,'Color','r','LineStyle','--')
    plot(ub,ib,'.k','MarkerSize',5,'markerfacecolor','black');
    if textcount <10
