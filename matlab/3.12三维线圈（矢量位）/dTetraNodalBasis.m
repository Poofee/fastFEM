...
%     grad = [det(VdBdx),det(VdBdy),det(VdBdz)]/V6;
    grad = cross([x(3)-x(2),y(3)-y(2),z(3)-z(2)],[x(2)-x(4),y(2)-y(4),z(2)-z(4)])/V6;
elseif n == 2
...
%              x(4)-x(3),y(4)-y(3),z(4)-z(3)];
%     grad = [det(VdBdx),det(VdBdy),det(VdBdz)]/V6;
    grad = cross([x(3)-x(1),y(3)-y(1),z(3)-z(1)],[x(4)-x(1),y(4)-y(1),z(4)-z(1)])/V6;
elseif n == 3
%     VdBdx = [x(4)-x(1),y(4)-y(1),z(4)-z(1);
%              x(4)-x(2),y(4)-y(2),z(4)-z(2);
%              -1       ,0        ,0       ];
...
%              0        ,0        ,-1      ];
%     grad = [det(VdBdx),det(VdBdy),det(VdBdz)]/V6;
    grad = cross([x(4)-x(1),y(4)-y(1),z(4)-z(1)],[x(2)-x(1),y(2)-y(1),z(2)-z(1)])/V6;
elseif n == 4
%     grad = -(dTetraNodalBasis(1,x,y,z,0,0,0)...
%             +dTetraNodalBasis(2,x,y,z,0,0,0)...
%             +dTetraNodalBasis(3,x,y,z,0,0,0));
    grad = cross([x(2)-x(1),y(2)-y(1),z(2)-z(1)],[x(3)-x(1),y(3)-y(1),z(3)-z(1)])/V6;
else
    grad = [];
    disp('节点编号错误');
end
